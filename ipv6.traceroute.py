...
# use standard linux /usr/bin/traceroute6 | /bin/traceroute6 utility
...
def thread_pinger(i, q):
  ...
  while True:
    ...
    if os.path.isfile ('/etc/solus-release'):
        args=['/usr/bin/traceroute6', '-q', '1', '--resolve-hostnames', str(ip)]
	sqlcmd = "INSERT INTO `trace_result_ipv6` (`trace_destination`,`trace_hop`, `trace_ip`, `trace_hostname`, `trace_time`) VALUES "
    else:
        args=['/usr/bin/traceroute6', '-q', '-1', str(ip)]
	sqlcmd = "INSERT INTO `trace_result_ipv6` (`trace_destination`,`trace_hop`, `trace_hostname`, `trace_ip`, `trace_time`) VALUES "
