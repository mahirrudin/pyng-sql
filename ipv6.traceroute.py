...
# use standard linux /usr/bin/traceroute6 utility
  ...
  while True:
    ...
    for item in tracedata:
        ...
        with connection.cursor() as cursor:
            ...
            sql = "INSERT INTO `trace_result_ipv6` (`trace_destination`, `trace_hop`, `trace_hostname`, `trace_ip`, `trace_time`) VALUES " + str(items)
            cursor.execute(sql)
            connection.commit()
